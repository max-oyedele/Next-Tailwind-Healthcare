...
const LabelContainer = () => {
  return (
    <div className="hidden md:flex justify-center items-center md:space-x-8 lg:space-x-16 h-16 bg-gray-200">
...
const TitleContainer = () => {
  return (
    <div className="flex flex-col items-center my-16">
      <span className="bock w-10/12 sm:w-6/12 md:w-4/12 text-center text-2xl font-bold">Your goals are as unique as you are</span>
      <span className="block w-10/12 sm:w-9/12 md:w-6/12 text-center text-sm mt-5">Because Health helps you optimize your body and mind using proven, physician-designed treatments to deliver ultra-personalized results.</span>
      <span className="block w-10/12 sm:w-10/12 md:w-8/12 text-center text-4xl font-bold mt-8">Specialist care at your fingertips</span>
  ...
  return (
    <div className="sm:flex px-4 md:px-24 my-16">
      ...
      <div className="w-full sm:w-1/2 px-5 py-5 flex flex-col justify-center">
        <span className="block text-xl font-bold">Because Health works</span>

        <span className="block text-sm font-bold mt-6">Preventive self-care</span>
        <span className="text-sm mt-1">Take control of your health with online options that are available to you, wherever you are.</span>

        <span className="block text-sm font-bold mt-6">The right treatment</span>
        <span className="text-sm mt-1">Get premium prescriptions and services formulated for results, with a money-back guarantee.*</span>

        <span className="block text-sm font-bold mt-6">Trusted physicians</span>
        <span className=" text-sm mt-1">Find information about procedures and assessments, such as cost, outcomes, and reviews.</span>

        <span className="block text-sm font-bold mt-6">Private and personal</span>
        <span className="text-sm mt-1">Prevent small issues from turning into bigger ones with a physician who really understands you.</span>
      </div>
    </div>
  )
}
      ...
      <div className="sm:flex my-16">
        <div id="img-part" className="w-full md:w-1/2 px-6 md:px-24 mt-6">
          ...
          <div className="flex justify-center mt-4">
            <span className="text-xs md:text-sm font-bold">Marvin McKinney, MD - &nbsp;</span>
            <span className="text-xs md:text-sm"> Board Certified Plastic Surgeon</span>
          </div>
        </div>
        <div id="txt-part" className="w-full md:w-1/2 flex flex-col justify-center mt-6 pl-4 pr-4 md:pr-24">
          <span className="text-xl font-bold">Improve your health</span>
          <span className="mt-6">Partner with your chosen physician, virtually and in person. Because Health is designed and delivered by integrative physicians dedicated to helping you achieve optimal health.</span>

          <div id="brand-part-phone" className="sm:hidden mt-6">
            <div className="bg-gray-100">
              <div className="flex justify-center items-center h-10">
                <span className="block w-1/2 text-xs text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span>
              </div>
    ...
    <div className="px-6 md:px-24 my-16">
      <div className="bg-gray-100 py-6">
        <div className="flex justify-center">
          <span className="text-xl font-bold">Optimal health, virtually and in person</span>
        </div>
        <div className="sm:flex">
          <div className="w-full sm:w-1/3 flex flex-col items-center mt-10">
            <img src="/home/online.png" alt="online" />
            <span className="mt-2">Online</span>
            <span className="block w-2/3 text-center text-sm mt-2">Speak with a specialist physician about your specific concerns and get treatments without leaving your house.</span>
          </div>
          <div className="w-full sm:w-1/3 flex flex-col items-center mt-10">
            <img src="/home/in-person.png" alt="in-person" />
            <span className="mt-2">In person</span>
            <span className="block w-2/3 text-center text-sm mt-2">Partner with a board-certified physician in person to get advanced health assessments and specialist procedures near you.</span>
          </div>
          <div className="w-full sm:w-1/3 flex flex-col items-center mt-10">
            <img src="/home/testing.png" alt="testing" />
            <span className="mt-2">Testing</span>
            <span className="block w-2/3 text-center text-sm mt-2">Take advantage of convenient in-office labs or get comprehensive testing collected in the comfort of your home.</span>
          </div>
        </div>
      </div>
    </div>
...
const StatContainer = () => {
  ...
  return (
    <div className="flex flex-col items-center my-16">
      ...
      <span className="block w-11/12 sm:w-1/2 text-sm text-center mt-6">Unlike conventional primary care or typical telemedicine, our physicians use integrative medicine to treat chronic conditions. Treatments may include medications, creams, injections, nutritional modifications, and various specialist procedures. See for yourself how our approach can transform your health.</span>
      <div className="px-6 md:px-24 sm:flex sm:space-x-10">
        <div className="bg-gray-100 flex flex-col mt-10 p-6">
          ...
          <span className="text-sm mt-2">Vitamin D</span>
          <span className="text-sm mt-4">From a baseline average of 40 ng/mL, our patients generally experience a 69-74% increase to their vitamin D levels in 6 months (optimum vitamin D levels range from 50-80ng/mL).</span>
        </div>
        <div className="bg-gray-100 flex flex-col mt-10 p-6">
          <span className="text-3xl text-primary-70">23%<IoIosArrowRoundDown className="inline text-primary-70" /></span>
          <span className="text-sm mt-2">Fasting Insulin</span>
          <span className="text-sm mt-4">From a baseline average of 40 ng/mL, our patients generally experience a 69-74% increase to their vitamin D levels in 6 months (optimum vitamin D levels range from 50-80ng/mL).</span>
        </div>
        <div className="bg-gray-100 flex flex-col mt-10 p-6">
          <span className="text-3xl text-primary-70">12%<IoIosArrowRoundDown className="inline text-primary-70" /></span>
          <span className="text-sm mt-2">HbA1c</span>
          <span className="text-sm mt-4">From a baseline average of 40 ng/mL, our patients generally experience a 69-74% increase to their vitamin D levels in 6 months (optimum vitamin D levels range from 50-80ng/mL).</span>
        </div>
      </div>
...
const ContentContainer = () => {
  return (
    <div className="flex flex-col items-center my-16">
      ...
      <span className="block w-11/12 sm:w-1/2 text-sm text-center mt-6">Discover clinically-validated, easy-to-read articles that provide answers to your most pressing healthcare questions.</span>
      <div className="px-6 md:px-24 sm:flex sm:space-x-10">
        <div className="mt-10">
          <img src="/home/content1.png" alt="content1" width="100%" className="rounded-t-md" />
          <div className="bg-gray-100 flex flex-col p-3">
            <span className="text-sm font-bold">Women's Health</span>
            <span className="text-xs mt-2">Because Health launches Workplace Health COVID-19 testing services</span>
          </div>
        </div>
        <div className="mt-10">
