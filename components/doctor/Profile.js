  ...
  return (
    <div className="px-6 md:px-36 my-16">
      <div className="flex flex-col items-center">
        <span className="text-2xl font-bold">Meet other doctors</span>
      </div>
